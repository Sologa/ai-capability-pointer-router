...
def validate_root_files(root: Path, errors: list[str]) -> None:
    required_files = [
        ...
        *REQUIRED_SCHEMA_FILES,
        ...
        "templates/paper-repo-taxonomy/README.md",
        "templates/paper-repo-taxonomy/route-registry-profile.yaml.tmpl",
        "templates/paper-repo-taxonomy/route-registry-route.yaml.tmpl",
        "templates/paper-repo-taxonomy/route-registry-source.yaml.tmpl",
        "templates/paper-repo-taxonomy/category-router.md.tmpl",
        "templates/paper-repo-taxonomy/source-card.md.tmpl",
        "templates/paper-repo-taxonomy/skill-category-section.md.tmpl",
